    ...
    internal class SerializedDataStorage : IDataStorage
    {
        ...
        private void FillPersons()
        {
            ...
            for (int i = 0; i < 50; i++)
            {
                ...
                AddPerson(new Person(firstNames[i], lastNames[i], emails[i] + "@ukma.edu.ua", birthday));
            }
        }
    }
}
